...
Aby poprzeć to przypuszczenie dowodami, postaram się wskazać aspekty filozofii
...
> Granice jego świata wytycza jego cielesne przeżywanie, do którego należą w
...
Uniwersalność i ponadczasowość zagrożenia, przed którym ostrzeżenia można
...
Można to rozumieć jako wezwanie do powrotu do świata _człowieka naturalnego_,
...
Jak już wcześniej wskazywałem, Buber za najbardziej nieszczęśliwy i błędny
...
Ale to nie koniec filozofii spotkania i dialogu jako potencjalnego remedium!
...
[^5]:
    Rozwinięcie treści tych propozycji teoretycznych nie byłoby w ramach
    niniejszego opracowania produktywne; zainteresowanego czytelnika odsyłam do
    źródeł w literaturze.

[^6]:
    Ang. _continuous cosmos_, pojęcie wprowadzone przez Charlesa Taylora
    (Taylor, 2007), tłumaczenie własne.

[^7]:
    Ang. _Axial Age_, pojęcie wprowadzone przez Karla Jaspersa (Jaspers, 2021),
    tłumaczenie własne.

[^8]:
    Ang. _second-order thinking_, pojęcie wprowadzone przez Roberta Bellaha
    (Bellah, 2005), tłumaczenie własne.

[^9]: Ang. _self-transcendence_, tłumaczenie własne.
[^10]:
    Ang. _worldview attunement_, pojęcie wprowadzone przez Clifforda Geertza
    (Geertz, 2017), tłumaczenie własne.
